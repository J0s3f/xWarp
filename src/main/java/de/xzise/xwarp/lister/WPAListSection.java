...
public class WPAListSection extends ListSection<WarpProtectionArea> {

    private final ImmutableSet<Column> columns;

    public WPAListSection(String title, int maximumLength, Set<Column> columns) {
        super(title, maximumLength);
        this.columns = ImmutableSet.copyOf(columns);
    }

    @Override
    public void print(WarpProtectionArea warp, CommandSender sender, Callback<Integer, String> widther, int width) {
